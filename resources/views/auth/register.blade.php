...
>
    ...
    <div class="flex items-center space-x">
        <p class="text-base font-extrabold text-left tracking-wide" style="font-family: 'Poppins', sans-serif;">Create Account</p>
        <img src="{{ asset('images/logo.png') }}" alt="Logo" class="h-10 w-16" />
    </div>
        ...
        <div class="mb-4">
            ...
            <div class="relative">
                ...
                <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V7.5A4.5 4.5 0 0 0 7.5 7.5v3M5.25 10.5h13.5v9.75H5.25V10.5Z" />
                    </svg>
                </span>
            </div>
