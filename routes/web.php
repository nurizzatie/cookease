...
Route::get('/run-migrations', function () {
    try {
        Artisan::call('migrate:fresh', ['--force' => true]); // or 'migrate' if you don’t want to wipe data
        Artisan::call('db:seed', ['--class' => 'RecipeSeeder', '--force' => true]);
        Artisan::call('db:seed', ['--class' => 'IngredientSeeder', '--force' => true]);

        return '✅ Migrations and seeders have been successfully run.';
    } catch (\Exception $e) {
